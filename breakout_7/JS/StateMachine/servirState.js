...
export class ServirState extends BaseState {
    constructor(sm, nivel, filaColor, spriteSheet, vidas = 3, score = 0) {
        super(sm);
        this.sm = sm; // stateMachine
        this.nivel = nivel;
        this.fila = filaColor;
        this.velocidadJugador = 400; // Velocidad del jugador Default 400
        this.velocidadBola = 500; // Velocidad de la bola inicial 500
        this.spriteSheet = spriteSheet;
        this.vidas = vidas; // Vidas del jugador Default 3
        this.score = score; // Puntuación del jugador
    }

    enter() {
        document.getElementById("servirState").style.display = "flex";
        document.getElementById("vidasText").style.display = "inline";        
