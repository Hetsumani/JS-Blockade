...
export class ServirState extends BaseState {
    ...
    enter() {
        ...
        // Asumimos que this.spriteSheet ya está cargado y disponible.
        // Asumimos que this.nivel contiene el nivel actual (ej. 1, 2, 3...).
        ...
        for (let j = 0; j < this.nivel; j++) {
            ...
            for (let i = 0; i < bloquesPorHilera; i++) {
                ...
                const bloque = new Bloque(
                    this.spriteSheet,
                    0, // columna en el spritesheet (puedes variarla si tienes diferentes tipos de bloques)
                    filaSpriteBloque, // fila en el spritesheet
